                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="box box-primary">
                      ...
                      <form role="form" method="get" action="/admin/product/get" enctype="multipart/form-data">
                        <div class="box-body" style="text-align: center;">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              ...
                              <input type="hidden" name="type" id="type" value="${cri.type}" />
                              <input type="hidden" name="keyword" id="keyword" value="${cri.keyword}" />
                              <select class="form-control" id="firstCategory" disabled>
                            ...
                            <div class="col-sm-4">
                              <select class="form-control" id="secondCategory" name="cg_code" disabled>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" name="pd_discount" id="pd_discount"
                                value="${pd_vo.pd_discount}" readonly />
                            </div>
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" name="pd_company" id="pd_company"
                                value="${pd_vo.pd_company}" readonly />
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <textarea class="form-control" rows="3" name="pd_content" id="pd_content"
                                readonly>${pd_vo.pd_content}</textarea>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <input type="text" class="form-control" name="pd_amount" id="pd_amount"
                                value="${pd_vo.pd_amount}" readonly />
                            </div>
                            <label for="title" class="col-sm-2 col-form-label">판매 여부</label>
                            <div class="col-sm-4">
                              <select class="form-control" id="pd_buy_status" name="pd_buy_status" disabled>
                        ...
                        <div class="box-footer">
                          ...
                          <div class="text-center">
                            <button type="button" class="btn btn-success" id="btn_productList">목록</button>
                          </div>
                        </div>
                      </form>
                    </div>
      ...
      <%@ include file="/WEB-INF/views/admin/include/plugin2.jsp" %>
        ...
        <script>
          $(document).ready(function () {
            ...
            // 목록 버튼 클릭 이벤트
            $("#btn_productList").on('click', function () {
