...
<body>
				...
				<div class="box-header with-border">
					...
					<form role="form" method="post" action="/member/login">
						<div class="box-body">
							...
							<div class="form-group">
								<input type="password" class="form-control" name="us_pw"
									id="us_pw" placeholder="비밀번호">
							</div>
							<div></div>
						</div>
						<div class="box-footer">
							<div class="form-group row">
								<div class="col-6">
									<input type="checkbox" name="isRememberId" value="true"
					...
					<div class="login-footer">
						<a href="/member/info/find" id="linkFindId">아이디 찾기</a> | <a
							href="/member/info/find" id="linkFindPw">비밀번호 찾기</a> | <a
	...
	<script>
		...
		window.onload = function() {
			let rememberId = getCookie("remember_id");
			if (rememberId) {
				document.getElementById('us_id').value = rememberId;
			}
		};
