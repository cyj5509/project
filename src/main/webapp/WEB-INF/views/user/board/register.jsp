												...
												<div class="box-body">
														...
														<div class="col-4">
															<c:choose>
																<c:when test="${not empty sessionScope.userStatus}">
																	<%-- 로그인한 사용자의 경우 --%>
																		<input type="text" class="form-control" name="us_id" id="us_id_member"
																			value="${sessionScope.userStatus.us_id}" readonly>
																</c:when>
																<c:otherwise>
																	<%-- 비회원의 경우 --%>
																		<input type="text" class="form-control" name="us_id" id="us_id_guest"
																			placeholder="guest">
																</c:otherwise>
															</c:choose>
														</div>
													...
													<c:if test="${empty sessionScope.userStatus}">
														<div class="form-group row">
															...
															<div class="col-4">
																<input type="password" class="form-control" name="bd_guest_pw" id="guest_pw2"
