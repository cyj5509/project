					...
					<form role="form" method="post" action="./modify"> <!-- 절대 경로: /user/board/register와 동일 -->
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="bd_number" id="bd_number" value="${board.bd_number}" readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="us_id" id="us_id" value="${board.us_id}" readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="bd_registe_date" id="bd_registe_date" value='<fmt:formatDate value="${board.bd_registe_date}" pattern="yyyy/MM/dd" />' readonly>
							</div>
							<div class="form-group">
								<label for="bd_update_date">수정일</label>
								<input type="text" class="form-control" name="bd_update_date" id="bd_update_date" value='<fmt:formatDate value="${board.bd_update_date}" pattern="yyyy/MM/dd" />' readonly>
							</div>
