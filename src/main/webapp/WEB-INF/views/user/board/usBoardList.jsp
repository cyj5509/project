			...
			<body>
				...
				<%@include file="/WEB-INF/views/comm/header.jsp" %>
					...
					<ul class="horizontal-menu">
						<li><a href="/user/board/usBoardList/total">전체 게시판</a></li>
						<li><a href="/user/board/usBoardList/notice">공지사항</a></li>
						<li><a href="/user/board/usBoardList/free">자유 게시판</a></li>
						<li><a href="/user/board/usBoardList/info">정보 공유</a></li>
						<li><a href="/user/board/usBoardList/study">스터디 모집</a></li>
						<li><a href="/user/board/usBoardList/project">프로젝트 모집</a></li>
						<li><a href="/user/board/usBoardList/inquery">문의(Q&A)</a></li>
					</ul>
										...
										<div class="box">
											...
											<div class="row" style="text-align: right;">
												<div class="col-12">
													...
													<form id="actionForm" action="/user/board/usBoardList/${bd_type}" method="get">
														...
														<nav aria-label="...">
															<ul class="pagination">
																...
																<c:if test="${pageMaker.foremost}">
																	<li class="page-item">
																		<a href="/user/board/usBoardList/${bd_type}?pageNum=1" class="page-link"
																...
																<c:if test="${pageMaker.prev}">
																	<li class="page-item">
																		<a href="/user/board/usBoardList/${bd_type}?pageNum=${pageMaker.startPage - 1}"
																...
																<c:if test="${pageMaker.next}">
																	<li class="page-item">
																		<a href="/user/board/usBoardList/${bd_type}?pageNum=${pageMaker.endPage + 1}"
																...
																<c:if test="${pageMaker.rearmost}">
																	<li class="page-item">
																		<a href="/user/board/usBoardList/${bd_type}?pageNum=${pageMaker.readEnd}" class="page-link"
					...
					<script>
						...
						Array.from(movePages).forEach(function (mv_page) {
							...
							mv_page.addEventListener("click", function (event) {
								...
								actionForm.setAttribute("action", "/user/board/usBoardList/${bd_type}");
								actionForm.submit(); // /user/board/usBoardList로 전송
							});
						});
						...
						Array.from(moves).forEach(function (move) {
							...
							move.addEventListener("click", function (event) {
								...
								actionForm.setAttribute("action", "/user/board/get/${bd_type}"); // /user/board/usBoardList -> /user/board/get 전송
								actionForm.submit();
							});
						});
					</script>
